...
sys.path.append(str(Path(__file__).parent.parent))  # user_data/scripts
...
from validation.logging_utils import configure  # noqa: E402
...
def main() -> int:
    ...
    print("=" * 64)
    scratch = Path("user_data/backtest_results/selftest")
