...
## 3. Strategy activation: 14 registered, 14 scanning

The production library now contains only the 14 enabled intraday strategies
(5 x 5m, 8 x 15m, 1 x 1h). All 14 declare `HoldingScope.INTRADAY`, are discovered
